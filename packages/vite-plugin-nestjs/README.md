...
A working example is available in the [repository](https://github.com/Alan-Gomes/vite-plugin-nestjs/tree/main/examples/basic-nest). It demonstrates:
...
Bug reports and pull requests are welcome. See [CONTRIBUTING.md](https://github.com/Alan-Gomes/vite-plugin-nestjs/blob/main/CONTRIBUTING.md) for details.

---

## License

[MIT](https://github.com/Alan-Gomes/vite-plugin-nestjs/blob/main/LICENSE)
